...
- Create two apps on Fly, one for staging and one for production:
  ...
  ```sh
  fly create estimator-4d1b
  fly create estimator-4d1b-staging
  ```
...
- Add a `SESSION_SECRET` to your fly app secrets, to do this you can run the following commands:
  ...
  ```sh
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app estimator-4d1b
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app estimator-4d1b-staging
  ```
...
- Create a database for both your staging and production environments. Run the following:
  ...
  ```sh
  fly postgres create --name estimator-4d1b-db
  fly postgres attach --postgres-app estimator-4d1b-db --app estimator-4d1b

  fly postgres create --name estimator-4d1b-staging-db
  fly postgres attach --postgres-app estimator-4d1b-staging-db --app estimator-4d1b-staging
  ```
